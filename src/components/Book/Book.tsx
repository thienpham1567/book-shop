            ...
            <Row className='format'>
              ...
              <div className="content-format-mobile">
                <Dropdown className='format-dropdown'>
                  <Dropdown.Toggle variant="" id="format-option" className='w-100 d-flex justify-content-between align-items-center'>
                    ...
                    {book.variant_groups[0].options.map((format) => (
                      <Dropdown.Item key={format.id}>
                        <div className='d-flex align-items-center gap-2'>
                          ...
                          <p className="fw-semibold">{format.price.formatted_with_symbol}</p>
                          <p>(English)</p>
                        </div>
                      </Dropdown.Item>
                    ))}
